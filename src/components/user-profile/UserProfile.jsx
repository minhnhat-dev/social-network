...
import { getFriendsByUserId, unFollow, follow } from "../../handlers/user.handler"
            ...
            <div className="user-profile-right__header">
                {user.id !== userCurrent.id && (
                    <div className="user-profile-right__header__actions">
                        <button
                            className="user-profile-right__header__actions__add-friend"
                            type="button"
                            onClick={handleAddFriend}
                        >
                            {isFollow ? <i className="fas fa-user-check" /> : <i className="fas fa-user-plus" />}{" "}
                            <span>{isFollow ? "UnFollow" : "Follow"} friend</span>
                        </button>
                        <button className="user-profile-right__header__actions__inbox" type="button">
                            <i className="far fa-comment-alt" /> <span>Chat</span>
                        </button>
                    </div>
                )}
                ...
                <div className="user-profile-right__header__information">
                    ...
                    <span className="user-profile-right__header__information__value">
                        {RELATIONSHIP_STRING[user.relationship]}
                    </span>
                </div>
            </div>
                    ...
                    {friends.map(item => {
                        ...
                        return (
                            <div className="user-profile-right__followings__profiles__item">
                                ...
                                <span className="user-profile-right__followings__profiles__item__username">
                                    {userItem.name}
                                </span>
                            </div>
                        )
